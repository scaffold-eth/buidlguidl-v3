...
import { SRE_CHALLENGE_SUBMISSION_STATUS } from "../helpers/constants";
...
const ChallengeStatusTag = ({ status, comment, autograding }) => {
  ...
  switch (status) {
    case SRE_CHALLENGE_SUBMISSION_STATUS.ACCEPTED: {
      colorScheme = "green";
      label = "Accepted";
      break;
    }
    case SRE_CHALLENGE_SUBMISSION_STATUS.REJECTED: {
      colorScheme = "red";
      label = "Rejected";
      break;
    }
    case SRE_CHALLENGE_SUBMISSION_STATUS.SUBMITTED: {
      label = "Submitted";
      break;
    }
    default:
  ...
  return (
    <>
      <Flex align="center">
        ...
        <Spacer />
        {status !== SRE_CHALLENGE_SUBMISSION_STATUS.SUBMITTED && comment && (
